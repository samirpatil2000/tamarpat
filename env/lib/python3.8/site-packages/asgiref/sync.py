...
class AsyncToSync:
    ...
    def __call__(self, *args, **kwargs):
        ...
        # main1 event loop's thread if it's there, otherwise make a new loop
        # in this thread.
        try:
...
class SyncToAsync:
    ...
    outermost), this will just be the main1 thread. This is achieved by idling
    ...
    # Storage for main1 event loop references
